...
classdef OrientationAnalysis < handle
    ...
    methods
        ...
        %% ========================== setImageFromFile ====================
        function setImageFromFile(self, imagePath)
            % setImageFromFile(self, imagePath)
            %
            % Loads an image from the specified file path, and sets it as the current image
            self.imagePath = imagePath;
            self.setImage(imread(imagePath));
        end
        ...
        %% ======================== computeRadonPeaks ==========================
        function radonPeaks = computeRadonPeaks(self)
            ...
            radonPeaks = self.imageRadon(ceil(numRadonRows/2),:);
            self.radonPeaks = radonPeaks;
        end
